...
## User
- [User Profile](user_profile.md) — Bagus Pdam, PDAM dev, Indonesian, delegates to juniors/AI

## Feedback
- [Documentation Style](feedback_docs_style.md) — Issues in Indonesian, high-level, structured, use Context7
...
## Reference
- [Issue Document Template](project_issue_template.md) — Template, conventions, phrases, step-by-step guide for new issues
- [DB Schema Reference](project_db_schema.md) — Source (smartoffice) & target (kepegawaian) tables, columns, indexes
